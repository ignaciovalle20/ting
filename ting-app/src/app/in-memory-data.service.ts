...
export class InMemoryDataService {
 ...
 const rooms: Room[] = [
    ...
    const funciones: Funciones[] = [
      ...
      { id: '1', movie:  movies[0] , theater: "Mdeo Shop", date: "2022-10-31", horario: "21:10", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[0] , theater: "Punta Carretas ", date: "2022-10-31", horario: "21:20", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[0] , theater: "Nuevo Centro", date: "2022-10-31", horario: "21:30", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[0] , theater: "Interior", date: "2022-10-31", horario: "21:40", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[1] , theater: "Tres Cruces", date: "2022-10-31", horario: "22:00", price: 100, room: [rooms[0]], seatsunavailable: [] },
      { id: '1', movie:  movies[1] , theater: "Tres Cruces", date: "2022-10-31", horario: "22:10", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[1] , theater: "Tres Cruces", date: "2022-10-31", horario: "22:20", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[1] , theater: "Tres Cruces", date: "2022-10-31", horario: "22:00", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[1] , theater: "Tres Cruces", date: "2022-10-31", horario: "22:10", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[1] , theater: "Tres Cruces", date: "2022-10-31", horario: "22:20", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[1] , theater: "Tres Cruces", date: "2022-10-31", horario: "22:00", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[1] , theater: "Tres Cruces", date: "2022-10-31", horario: "22:10", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[1] , theater: "Tres Cruces", date: "2022-10-31", horario: "22:20", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[1] , theater: "18 Julio", date: "2022-10-31", horario: "22:10", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '2', movie: movies[1], theater: "Costa Urbana", date: "2022-10-31", horario: "22:20", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[3] , theater: "Tres Cruces", date: "2022-10-31", horario: "21:00", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[3] , theater: "Mdeo Shop", date: "2022-10-31", horario: "21:10", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[3] , theater: "Punta Carretas ", date: "2022-10-31", horario: "21:20", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[3] , theater: "Nuevo Centro", date: "2022-10-31", horario: "21:30", price: 100, room: [rooms[0]], seatsunavailable: []},
      { id: '1', movie:  movies[3] , theater: "Interior", date: "2022-10-31", horario: "21:40", price: 100, room: [rooms[0]], seatsunavailable: []}
    ];
