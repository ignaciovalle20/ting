...
export class InMemoryDataService {
  ...
  createDb() {
    ...
    const funciones: Funciones[] = [
      { id: '1', movie:  movies[0] , theater: "Tres Cruces", date: "2022-10-09", horario: "21:00", price: 100, seats: [seats[0]]},
      { id: '1', movie:  movies[0] , theater: "Mdeo Shop", date: "2022-10-09", horario: "21:10", price: 100, seats: [seats[0]]},
      { id: '1', movie:  movies[0] , theater: "Punta Carretas ", date: "2022-10-09", horario: "21:20", price: 100, seats: [seats[0]]},
      { id: '1', movie:  movies[0] , theater: "Nuevo Centro", date: "2022-10-09", horario: "21:30", price: 100, seats: [seats[0]]},
